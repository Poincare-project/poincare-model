...
if __name__ == "__main__":
    ...
    train_relations_path = os.path.join(DATA_DIRECTORY, 'train_relation.tsv')
    test_relations_path = os.path.join(DATA_DIRECTORY, 'test_relation.tsv')
    # open train and test relations
    
    
    generate_bench_mark(train_relations_path,test_relations_path)
